...
words_arr = (open('word_cloud/stop-words.txt', 'r', encoding='UTF-8').readlines())
stop_words = list(map(lambda x: x[:-1], words_arr))
a = 'что' in stop_words
...
create_default_word_cloud(file_name='test', text="""
